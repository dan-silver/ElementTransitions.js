var PageTransitions=function(t){function n(){var t=document.body||document.documentElement,n=t.style,a="animation";if("string"==typeof n[a])return"animation";v=["Moz","Webkit","Khtml","O","ms"],a=a.charAt(0).toUpperCase()+a.substr(1);for(var i=0;i<v.length;i++)if("string"==typeof n[v[i]+a])return v[i]+a;return!1}function a(){t(".et-page").each(function(){t(this).data("originalClassList",t(this).attr("class"))}),t(".et-wrapper").each(function(){t(this).data("current",0),t(this).data("isAnimating",!1),t(this).children(".et-page").eq(u).addClass("et-page-current")}),t(".et-rotate").click(function(){i(t(this))})}function i(n,a){e(t(n).closest(".et-wrapper"),t(n).attr("et-out"),t(n).attr("et-in"),a)}function e(n,a,i,e){n=t(n),i=o(i),a=o(a);var s=n.data("current"),u=n.children(".et-page"),c=u.length,d=!1,m=!1;if(n.data("isAnimating"))return!1;n.data("isAnimating",!0);var l=u.eq(s);c-1>s?s++:s=0,n.data("current",s);var g=u.eq(s).addClass("et-page-current");n.trigger("onStartAnimation",[l,g]),l.addClass(a).on(animEndEventName,function(){l.off(animEndEventName),d=!0,m&&(jQuery.isFunction(e)&&e(n,g,l),r(l,g,n))}),g.addClass(i).on(animEndEventName,function(){g.off(animEndEventName),m=!0,d&&r(l,g,n)})}function r(t,n,a){s(t,n),a.data("isAnimating",!1),a.trigger("onEndAnimation",[t,n])}function s(t,n){t.attr("class",t.data("originalClassList")),n.attr("class",n.data("originalClassList")+" et-page-current")}function o(t){classes=t.split(" "),output="";for(var n=0;n<classes.length;n++)output+=" pt-page-"+classes[n];return output}var u=0,c={WebkitAnimation:"webkitAnimationEnd",OAnimation:"oAnimationEnd",msAnimation:"MSAnimationEnd",animation:"animationend"};return animEndEventName=c[n()],{init:a,nextPage:e,animate:i}}(jQuery);jQuery(function(){PageTransitions.init()});
